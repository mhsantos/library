...
/**
 * YCSB Server version implementing the Collaborative State Transfer protocol described in:
 * https://www.usenix.org/system/files/conference/atc13/atc13-bessani.pdf
 * 
 ...
 *
 */
public class YCSBServerCST extends DurabilityCoordinator {
	...
	public static void main(String[] args) throws Exception	{
		if (args.length == 1) {
			new YCSBServerCST(new Integer(args[0]));
		} else {
			printUsage();
		}
	}
